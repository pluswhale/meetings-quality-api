...
### Шаг 5: Доступ к Swagger документации
...
Используйте Swagger/OpenAPI для автоматической генерации типизированного API клиента с Orval и React Query.

📚 **Подробная инструкция:** См. [SWAGGER.md](SWAGGER.md)
...
# Скопируйте конфиг
cp orval.config.example.ts ../your-frontend/orval.config.ts
